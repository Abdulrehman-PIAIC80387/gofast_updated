...
class Invoice(models.Model):
	...
	custumer_name = models.CharField('Customer Name', max_length=120, default='null', blank=True, null=True)
	...
	date_time = models.DateTimeField("date_time", null=True,blank=True)
	geeks_field = models.TimeField("geek", null=True,blank=True,default=now)
